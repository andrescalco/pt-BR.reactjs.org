...
No React 15.4.0, nós estmos finalmente movendo a implementção do React DOM para o pacote React DOM. O pacote React irá ter apenas código relacionado a renderização como `React.Component` e `React.createElement()`.
